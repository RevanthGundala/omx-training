...
config = TrainConfig(
    ...
    policy_repo_id="RevanthGundala/pi05-pour-water-70-from-3k-globalstats",
    job_name="pi05_pour_water_70_from_3k_globalstats",
    instance_label="omx-pi05-70-from-3k-globalstats",
    steps=3000,
    compile_model=False,
)
